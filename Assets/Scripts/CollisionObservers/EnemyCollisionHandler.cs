...
public class EnemyCollisionHandler : ICollisionHandler<IEnemy>
{
    ...
    public void HandleCollision(IEnemy collidedObject)
    {
        ...
        {
            if (_character.SM.StateCondition(CharacterStateType.Fear)) return;
            ...
            Vector3 direction = _character.Components.characterTransform.position -
                                collidedObject._Character.Components.characterTransform.position;
            direction.y = 0;
            Quaternion rotation = Quaternion.LookRotation(direction);
            collidedObject._Character.Components.characterTransform.rotation =
